...
export function SourceLeads() {
    ...
    return (
        ...
        <div class="min-h-[500px] bg-white rounded-lg shadow dark:bg-gray-900 p-2 md:p-6">
            <div class="flex justify-between ">
                <div class="flex justify-center items-center">
                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Leads by Source</h5>
                    <svg data-popover-target="chart-info" data-popover-placement="bottom" class="w-3.5 h-3.5 text-gray-100 dark:text-gray-400 hover:text-gray-100 dark:hover:text-white cursor-pointer ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
                <div class="flex pt-2" id="devices">
